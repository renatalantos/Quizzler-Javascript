//Images, questions, choices and correct answers are in questions array. The images are part of the questions.
let questions = [
...

  {
    ...
    choice3: 'C' + '\xa0\xa0\xa0\xa0' + 'René Goscinny',
...
function restartPage() {
  ...
  /*if (questionCounter = 0) {
    photoContainer.append(mainImage)
  } else {
    photoContainer.append(photoArea)
  }*/
  questionCounter=0;
  //let questionContainer = document.querySelector('#question-area')
